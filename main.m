...
% from the test set.
n_sentences_train = 300; n_sentences_test = 10;
...
%% Block Coordinate Frank-Wolfe algorithm with gap sampling
...
%% Block Coordinate Frank-Wolfe algorithm with uniform sampling
